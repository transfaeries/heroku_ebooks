...
USER_ACCESS_FILENAME = 'faebot' # The MASTODON user credential file you created at installation.
...
TEST_SOURCE = "transfaerie_tweets.txt"  # The name of a text file of a string-ified list for testing. To avoid unnecessarily hitting Twitter API. You can use the included testcorpus.txt, if needed.
...
TWEET_ACCOUNT = "faebot01"  # The name of the account you're tweeting to.
